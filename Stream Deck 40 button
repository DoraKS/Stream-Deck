...
int get_keypad_1() {
 ...
 return 1;
 }//you can change the "return x;" to whatever you want like using a keyboard library you can make it to copy or paste something
 else if(val>900){
  Keyboard.press(0xF1);
  delay(40);
